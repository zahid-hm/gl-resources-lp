...
import { ArrowRight, Quote, Lock, Mail, Shield, Check, Building2, Target, Calendar, Clock } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/linkedin-commercial-hero.webp" srcSet="/images/hero/linkedin-commercial-hero-sm.webp 800w, /images/hero/linkedin-commercial-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">LinkedIn Outbound For Commercial Real Estate</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Connect With Property Owners And Investors
              <br />
              <span className="text-spark-400">The Best Deals Come From Relationships, Not Listings.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-6">
              Build a predictable pipeline of high-quality deal flow. We find and connect your firm with property owners, private equity, and institutional investors who need your market expertise.
            </p>

            <ul className="gl-reveal gl-d25 space-y-2 mb-8">
              {[
                "Better access to off-market conversations",
                "Relationship-led outreach, managed for you",
                "More consistent prospecting without more admin",
              ].map((b, i) => (
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                { icon: Target, text: "15–25 New connections/mo" },
                { icon: Calendar, text: "14 Days Outreach live" },
                { icon: Clock, text: "0 Hrs Your time on LinkedIn" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;LinkedIn outreach opened doors to off-market deals we never would have found through traditional brokerage channels.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                ...
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Senior Broker</p>
                  <p className="text-xs text-gray-400">Commercial Real Estate Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-commercial-re-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: LinkedInCommercialREPage
   ════════════════════════════════════════════════════════════════════════════ */
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "LinkedIn Outbound for Commercial Real Estate | Get Levrg",
        description: "Connect with property owners, private equity, and institutional investors through targeted LinkedIn outreach. Build predictable deal flow for your CRE firm.",
        keywords: "LinkedIn outbound for commercial real estate, CRE lead generation, commercial real estate LinkedIn prospecting",
        ogTitle: "LinkedIn Outbound for Commercial Real Estate | Get Levrg",
        ogDescription: "The best deals come from relationships, not listings.",
        ogImage: "/images/hero/linkedin-commercial-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <WhyChooseUsSection />
      <HowItWorksSection />
      <TestimonialsSection industry="commercial-real-estate" />
      <FAQSection />
      <FinalCTASection />
    </PageShell>
  );
