...
/* ════════════════════════════════════════════════════════════════════════════
   VARIANT 1 — "Watch, Then Convert", mobile app pattern
   Same "Watch, Then Convert" copy as before, but on mobile:
...
/** Same reasons-to-choose-us as SocialPageV2's "Get All Three" section —
...
const processSteps = [
  { title: "Kickoff", timeline: "Day 1-2" },
  { title: "Strategy + Calendar", timeline: "Day 3-7" },
  { title: "First Posts Live", timeline: "Day 8-14" },
  { title: "Ongoing + Optimization", timeline: "Week 3+" },
];

const subheading =
  "Get a dedicated social media team to handle strategy, copy, design, scheduling, and reporting across LinkedIn, Instagram, and Facebook. You focus on the business. We keep it consistent.";
      ...
      <div className="relative z-10 w-full">
        ...
        <div className="px-6 sm:px-10 lg:px-16 max-w-container mx-auto w-full pt-16 lg:pt-6 sm:pt-8 text-center">
          ...
          >
            ...
            <br />
            <span className="text-[#51B027]">Without Hiring a Team</span>
          </h1>
        </div>
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:items-center gap-6 lg:gap-10 px-6 sm:px-10 lg:px-16 max-w-container mx-auto w-full">
          ...
          >
            <div className="w-full rounded-2xl border border-gray-200 bg-white shadow-2xl p-4 sm:p-5">
              ...
              <LeadForm idPrefix="social-v1-desktop" />
            </div>
  ...
  return (
    ...
    >
      ...
      <MobileInfoSheet open={formOpen} onClose={() => setFormOpen(false)} title="Let&apos;s Start Today">
        <LeadForm idPrefix="social-v1-mobile" onSubmitted={() => setFormOpen(false)} />
      </MobileInfoSheet>
