...
import { ArrowRight, Quote, Lock, Mail, Shield, Calculator, Calendar, TrendingUp, CheckCircle } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/crm-accounting-hero.webp" srcSet="/images/hero/crm-accounting-hero-sm.webp 800w, /images/hero/crm-accounting-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">CRM Data Cleanup For Accounting Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Clean up your CRM so nothing falls through
              <br />
              <span className="text-spark-400">Your client data is a mess. Your revenue doesn&apos;t have to be.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a team that cleans up your CRM, builds proper workflows, and ensures every client touchpoint is tracked — so no engagement, renewal, or referral opportunity slips through the cracks.
            </p>

            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                { icon: Calendar, text: "14 Days CRM clean and organized" },
                { icon: CheckCircle, text: "0 Dropped follow-ups" },
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="crm-accounting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "CRM Data Cleanup for Accounting Firms | Get Levrg",
        description: "Clean up your CRM, build proper workflows, and ensure every client touchpoint is tracked. No engagement, renewal, or referral slips through the cracks.",
        keywords: "CRM cleanup for accounting firms, CPA firm CRM optimization, accounting CRM data management",
        ogTitle: "CRM Data Cleanup for Accounting Firms | Get Levrg",
        ogDescription: "Your client data is a mess. Your revenue doesn't have to be.",
        ogImage: "/images/hero/crm-accounting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
