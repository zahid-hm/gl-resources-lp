...
import { ArrowRight, Smartphone, Clock, Quote, Lock, Mail, Shield, Calculator } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-accounting-hero.webp" srcSet="/images/hero/social-accounting-hero-sm.webp 800w, /images/hero/social-accounting-hero.webp 1440w" sizes="100vw" width="1440" height="785" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Social Media for Accounting Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Social Media Management Built For Accounting Firms
              <br />
              <span className="text-spark-400">Your Firm Should Be Visible. Your Partners Shouldn&apos;t Have To Post.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a dedicated social media team that plans, creates, and publishes professional content across LinkedIn, Facebook, and Instagram keeping your firm top of mind without anyone at the firm writing a single post.
            </p>
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                ...
                { icon: Calculator, text: "Strategy & Creative Managed" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-accounting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media Management for Accounting Firms | Get Levrg",
        description: "Dedicated social media team for accounting and CPA firms. 12–20 posts monthly on LinkedIn, Facebook, and Instagram. No partner time required. Live in 14 days.",
        keywords: "social media management for accounting firms, CPA firm social media, accountant LinkedIn management",
        ogTitle: "Social Media Management for Accounting Firms | Get Levrg",
        ogDescription: "Keep your accounting firm top of mind without anyone writing a single post.",
        ogImage: "/images/hero/social-accounting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="accounting" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
