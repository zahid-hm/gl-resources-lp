...
import { ArrowRight, Zap, TrendingUp, Shield, Star, CalendarDays, Lock, Mail, Calculator, Film, Video, Sparkles, Palette } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img src="/images/hero/video-accounting-hero.webp" srcSet="/images/hero/video-accounting-hero-sm.webp 800w, /images/hero/video-accounting-hero.webp 1440w" sizes="100vw" width="1440" height="804"
          alt=""
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a dedicated video editing team that turns raw recordings into professional thought leadership videos, client education content, and social clips without anyone at your firm learning Premiere Pro.
            </p>
          ...
          <HeroFormIntro animation={<VideoAnimation config={{
            ...
            headerTitle: "Financial Content",
            stats: [
              { icon: Film, label: "Tax Explainers", value: "4/mo", delay: 0.5, accent: "bg-sky-50 border-sky-200", iconColor: "text-sky-500", valueColor: "text-sky-700" },
              { icon: Video, label: "Client Education", value: "8/mo", delay: 0.8, accent: "bg-spark-50 border-spark-200", iconColor: "text-spark-600", valueColor: "text-[#4A6F27]" },
              { icon: Sparkles, label: "Thought Leadership", value: "4/mo", delay: 1.1, accent: "bg-teal-50 border-teal-200", iconColor: "text-teal-500", valueColor: "text-teal-700" },
            ...
            <div className="rounded-2xl border border-gray-200 bg-white/95 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
              ...
              <form id="video-accounting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Video Editing for Accounting Firms | Get Levrg",
        description: "Professional video content for accounting firms — thought leadership videos and client education content, no editing software required on your end.",
        keywords: "video editing for accounting firms, CPA video content, accounting firm thought leadership video",
        ogTitle: "Video Editing for Accounting Firms | Get Levrg",
        ogDescription: "Professional video content for accounting firms without anyone learning Premiere Pro.",
        ogImage: "/images/hero/video-accounting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
