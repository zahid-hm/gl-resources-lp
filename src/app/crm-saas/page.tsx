  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/crm-saas-hero.webp" srcSet="/images/hero/crm-saas-hero-sm.webp 800w, /images/hero/crm-saas-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="crm-saas-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
  ...
  return (
    <PageShell
      ...
      meta={{
        ...
        description: "Get more out of HubSpot without hiring ops. Clean data, automated workflows, custom dashboards, and lifecycle management — optimization complete in 14 days.",
        ...
        ogImage: "/images/hero/crm-saas-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
