...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, Monitor } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/website-optimization-it-services-hero.webp" srcSet="/images/hero/website-optimization-it-services-hero-sm.webp 800w, /images/hero/website-optimization-it-services-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-it-services-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
  ...
  return (
    <PageShell
      ...
      meta={{
        ...
        ogImage: "/images/hero/website-optimization-it-services-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
