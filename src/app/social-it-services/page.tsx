...
import { ArrowRight, Smartphone, Clock, Quote, Lock, Mail, Shield } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-it-services-hero.webp" srcSet="/images/hero/social-it-services-hero-sm.webp 800w, /images/hero/social-it-services-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              <Shield className="h-3.5 w-3.5 text-spark-300" />
              <span className="text-sm-body font-medium text-white">Social Media for IT Service Providers</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Build Thought Leadership In Your IT Niche
              <br />
              <span className="text-spark-400">Your Clients Need To Trust Your IT Team Before They Sign.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a social media team that positions your IT services firm as the authority cybersecurity insights, tech tips, and company updates that build credibility and generate inbound leads.
            </p>
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                ...
                { icon: Shield, text: "Strategy & Creative Managed" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <div className="flex items-center gap-3 pl-8">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Regional IT Services Provider</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-it-services-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media Management for IT Service Providers | Get Levrg",
        description: "Build thought leadership in your IT niche — cybersecurity insights, tech tips, and updates that generate inbound leads from a dedicated social media team.",
        keywords: "social media for IT companies, IT services LinkedIn management, managed services provider social media",
        ogTitle: "Social Media Management for IT Service Providers | Get Levrg",
        ogDescription: "Build credibility and generate inbound leads with consistent IT thought leadership content.",
        ogImage: "/images/hero/social-it-services-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="it-services" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
