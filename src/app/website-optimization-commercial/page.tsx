        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-commercial-re-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Website Optimization for Commercial Real Estate | Get Levrg",
        description: "Turn property searches into qualified inquiries. Better listing pages, faster search, and conversion-focused design for commercial real estate brokerages.",
        keywords: "website optimization for commercial real estate, CRE website design, commercial real estate website conversion",
        ogTitle: "Website Optimization for Commercial Real Estate | Get Levrg",
        ogDescription: "Your listings get views. They should be getting inquiries.",
        ogImage: "/images/hero/website-optimization-commercial-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
