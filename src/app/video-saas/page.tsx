...
import { ArrowRight, Zap, TrendingUp, Star, CalendarDays, Code, Film, Video, Sparkles, Palette } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img src="/images/hero/video-saas-hero.webp" srcSet="/images/hero/video-saas-hero-sm.webp 800w, /images/hero/video-saas-hero.webp 1440w" sizes="100vw" width="1440" height="804"
          alt=""
      ...
      <div className="relative z-10 max-w-container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">
                Video Editing for SaaS Teams
              </span>
            </div>

            {/* Headline */}
            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Ship Product Content
              <br />
              <span className="text-[#51B027]">
                As Fast As You Ship Features
              </span>
            </h1>

            {/* Subheadline */}
            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a dedicated video editing team that turns screen recordings into polished product demos, explainer videos, and social clips so your marketing keeps pace with your product team.
            </p>
          ...
          <HeroFormIntro animation={<VideoAnimation config={{
            headerIcon: Code,
            headerTitle: "Product Content",
            stats: [
              { icon: Film, label: "Feature Demos", value: "8/mo", delay: 0.5, accent: "bg-sky-50 border-sky-200", iconColor: "text-sky-500", valueColor: "text-sky-700" },
              { icon: Video, label: "Social Clips", value: "12/mo", delay: 0.8, accent: "bg-spark-50 border-spark-200", iconColor: "text-spark-600", valueColor: "text-[#4A6F27]" },
              { icon: Sparkles, label: "Explainers", value: "4/mo", delay: 1.1, accent: "bg-teal-50 border-teal-200", iconColor: "text-teal-500", valueColor: "text-teal-700" },
              { icon: Palette, label: "Onboarding Videos", value: "4/mo", delay: 1.4, accent: "bg-amber-50 border-amber-200", iconColor: "text-amber-500", valueColor: "text-amber-700" },
            ],
          }} />}>
            <div className="rounded-2xl border border-gray-200 bg-white/95 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
              ...
              <form id="video-saas-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Video Editing for SaaS Companies | Get Levrg",
        description: "Product demos, explainers, and social clips for SaaS. Dedicated video editors turn screen recordings into polished content at the speed your product team ships.",
        keywords: "video editing for SaaS, product demo video, SaaS explainer video, screen recording editing",
        ogTitle: "Video Editing for SaaS Companies | Get Levrg",
        ogDescription: "Ship product content as fast as you ship features with a dedicated video editing team.",
        ogImage: "/images/hero/video-saas-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
