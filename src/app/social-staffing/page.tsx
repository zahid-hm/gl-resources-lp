  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-staffing-hero.webp" srcSet="/images/hero/social-staffing-hero-sm.webp 800w, /images/hero/social-staffing-hero.webp 1440w" sizes="100vw" width="1440" height="786" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Social Media for Staffing Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Attract Candidates And Clients Through Social
              <br />
              <span className="text-spark-400">Your Next Placement Starts With Visibility.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a social media team that builds your staffing firm&apos;s employer brand attracting both top candidates and hiring managers through consistent, professional content across LinkedIn and beyond.
            </p>
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                ...
                { icon: Users, text: "Strategy & Creative Managed" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <div className="flex items-center gap-3 pl-8">
                <img
                  src="/images/client/phil-wittmer.webp"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Regional Staffing Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-staffing-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media Management for Staffing Firms | Get Levrg",
        description: "Attract candidates and clients through consistent social media. Build your staffing firm's employer brand across LinkedIn and beyond.",
        keywords: "social media for staffing firms, staffing agency LinkedIn, employer brand social media",
        ogTitle: "Social Media Management for Staffing Firms | Get Levrg",
        ogDescription: "Your next placement starts with visibility. Build employer brand on social media.",
        ogImage: "/images/hero/social-staffing-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="staffing" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
