        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                ...
                { icon: Zap, text: "Real-time Data freshness" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <div className="flex items-center gap-3 pl-8">
                ...
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Director of Operations</p>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="crm-consulting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "CRM Reporting Dashboards for Consulting Firms | Get Levrg",
        description: "Build real-time CRM dashboards for consulting firms — project pipelines, revenue forecasts, utilization rates, and client health scores, updated automatically.",
        keywords: "CRM for consulting firms, consulting firm reporting dashboards, management consulting CRM optimization",
        ogTitle: "CRM Reporting Dashboards for Consulting Firms | Get Levrg",
        ogDescription: "Your team spends hours on reports that should be automatic.",
        ogImage: "/images/hero/crm-consulting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
