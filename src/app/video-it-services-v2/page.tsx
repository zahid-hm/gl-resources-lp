...
import {
  ...
  UserCheck, DollarSign, Film, MessageCircle, Rocket, Play, Pause, VolumeX,
  Sparkles, ListChecks,
} from "lucide-react";
...
/* ════════════════════════════════════════════════════════════════════════════
   ...
   - Neither the form nor the process steps sit inline on the mobile page —
     ...
     keeps the original hero + dedicated inline form section entirely as-is;
     none of this mobile chrome applies there.
   ════════════════════════════════════════════════════════════════════════════ */
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <AnimatedSection delay={0.15} className="hidden lg:block">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-xl p-6 sm:p-8">
              ...
              <LeadForm idPrefix="video-it-v2-desktop" />
            </div>
          </AnimatedSection>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <MobileInfoSheet open={formOpen} onClose={() => setFormOpen(false)} title="Let&apos;s Start Today">
        <LeadForm idPrefix="video-it-v2-mobile" onSubmitted={() => setFormOpen(false)} />
      </MobileInfoSheet>
