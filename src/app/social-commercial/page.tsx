  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-commercial-hero.webp" srcSet="/images/hero/social-commercial-hero-sm.webp 800w, /images/hero/social-commercial-hero.webp 1440w" sizes="100vw" width="1440" height="786" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-commercial-re-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media for Commercial Real Estate | Get Levrg",
        description: "Keep your brokerage top of mind with consistent social media — market updates, deal announcements, and insights that position your brokers as go-to experts.",
        keywords: "social media for commercial real estate, CRE brokerage LinkedIn, commercial real estate social media management",
        ogTitle: "Social Media for Commercial Real Estate | Get Levrg",
        ogDescription: "Market presence and visibility for commercial real estate brokerages.",
        ogImage: "/images/hero/social-commercial-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="commercial-real-estate" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
