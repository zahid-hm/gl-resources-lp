  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-architecture-hero.webp" srcSet="/images/hero/social-architecture-hero-sm.webp 800w, /images/hero/social-architecture-hero.webp 1440w" sizes="100vw" width="1440" height="803" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Social Media for Architecture Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Showcase Your Work Where Clients Are Looking
              <br />
              <span className="text-spark-400">Your Best Work Is In Buildings. It Should Also Be In Feeds.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a social media team that showcases your portfolio, project stories, and design philosophy across LinkedIn and Instagram turning completed projects into new business conversations.
            </p>
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <div className="flex items-center gap-3 pl-8">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Regional Architecture Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-architecture-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media Management for Architecture Firms | Get Levrg",
        description: "Showcase your portfolio where clients are looking — project stories, design philosophy, and thought leadership from a dedicated social media team.",
        keywords: "social media management for architecture firms, architecture firm LinkedIn, portfolio showcase social media",
        ogTitle: "Social Media Management for Architecture Firms | Get Levrg",
        ogDescription: "Turn completed projects into new business conversations with consistent social media.",
        ogImage: "/images/hero/social-architecture-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="architecture" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
