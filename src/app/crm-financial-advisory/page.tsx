...
import { ArrowRight, Quote, Lock, Mail, Shield, TrendingUp, Calendar, CheckCircle } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/crm-financial-advisory-hero.webp" srcSet="/images/hero/crm-financial-advisory-hero-sm.webp 800w, /images/hero/crm-financial-advisory-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">CRM For Financial Advisors</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Never lose track of a prospect or renewal
              <br />
              <span className="text-spark-400">Your client relationships deserve better than a spreadsheet.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a team that builds a CRM system for your advisory practice — prospect tracking, client lifecycle management, renewal reminders, and referral tracking that ensures no relationship falls through the cracks.
            </p>

            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                { icon: Calendar, text: "14 Days CRM live" },
                { icon: CheckCircle, text: "0 Missed renewals" },
                { icon: TrendingUp, text: "100% Client lifecycle visibility" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;We caught three renewal opportunities we would have completely missed. The CRM paid for itself in the first month.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                <img
                  src="/images/client/danny-bermant.webp"
                  alt="Senior Advisor"
                  loading="lazy"
                  decoding="async"
                ...
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Senior Advisor</p>
                  <p className="text-xs text-gray-400">Wealth Management Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="crm-financial-advisory-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "CRM Client Tracking for Financial Advisors | Get Levrg",
        description: "Build a CRM system for your advisory practice — prospect tracking, client lifecycle management, renewal reminders, and referral tracking. Live in 14 days.",
        keywords: "CRM for financial advisors, wealth management CRM, advisory practice client tracking",
        ogTitle: "CRM Client Tracking for Financial Advisors | Get Levrg",
        ogDescription: "Your client relationships deserve better than a spreadsheet.",
        ogImage: "/images/hero/crm-financial-advisory-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
