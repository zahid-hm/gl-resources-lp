...
import { ArrowRight, Smartphone, Clock, Quote, Lock, Mail, Shield, BookOpen } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-consulting-hero.webp" srcSet="/images/hero/social-consulting-hero-sm.webp 800w, /images/hero/social-consulting-hero.webp 1440w" sizes="100vw" width="1440" height="786" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Social Media for Consulting Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Get Consulting Insights In Front Of Decision-Makers
              <br />
              <span className="text-spark-400">Your Insights Are Valuable. They&apos;re Stuck In Slide Decks.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a social media team that transforms your consulting expertise into LinkedIn thought leadership, case study highlights, and industry commentary reaching the decision-makers who hire firms like yours.
            </p>
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                ...
                { icon: BookOpen, text: "Strategy & Creative Managed" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-consulting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media Management for Consulting Firms | Get Levrg",
        description: "Get consulting insights in front of decision-makers — LinkedIn thought leadership, case study highlights, and industry commentary from a dedicated team.",
        keywords: "social media for consulting firms, consulting LinkedIn management, thought leadership social media",
        ogTitle: "Social Media Management for Consulting Firms | Get Levrg",
        ogDescription: "Turn consulting expertise into LinkedIn thought leadership that reaches decision-makers.",
        ogImage: "/images/hero/social-consulting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="consulting" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
