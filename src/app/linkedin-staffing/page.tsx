...
import { ArrowRight, Quote, Lock, Mail, Shield, Check, Users, BarChart3, Calendar, Clock } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/linkedin-staffing-hero.webp" srcSet="/images/hero/linkedin-staffing-hero-sm.webp 800w, /images/hero/linkedin-staffing-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              <Users className="h-3.5 w-3.5 text-spark-300" />
              <span className="text-sm-body font-medium text-white">LinkedIn Outbound For Staffing &amp; Recruiting Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Scale Outreach For Staffing And Recruiting Firms
              <br />
              <span className="text-spark-400">More Placements Start With More Conversations.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-6">
              Scale your candidate and client outreach without hitting LinkedIn limits. Our managed teams handle the volume, so your recruiters can focus on interviews and placements.
            </p>

            <ul className="gl-reveal gl-d25 space-y-2 mb-8">
              {[
                "Candidate and client outreach support",
                "More recruiter time spent closing",
                "Managed prospecting without extra headcount",
              ].map((b, i) => (
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                { icon: BarChart3, text: "2x Outreach volume" },
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;Our recruiters went from spending half their day prospecting to spending all of it on qualified conversations.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                ...
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Director</p>
                  <p className="text-xs text-gray-400">Regional Staffing Agency</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-staffing-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "LinkedIn Outbound for Staffing & Recruiting | Get Levrg",
        description: "Scale candidate and client outreach without hitting LinkedIn limits. Our managed teams handle the volume so your recruiters can focus on placements.",
        keywords: "LinkedIn outbound for staffing firms, recruiting firm lead generation, staffing agency LinkedIn prospecting",
        ogTitle: "LinkedIn Outbound for Staffing & Recruiting | Get Levrg",
        ogDescription: "More placements start with more conversations.",
        ogImage: "/images/hero/linkedin-staffing-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <WhyChooseUsSection />
      <HowItWorksSection />
      <TestimonialsSection industry="staffing" />
      <FAQSection />
      <FinalCTASection />
    </PageShell>
  );
