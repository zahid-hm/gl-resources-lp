...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, Scale } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/website-optimization-legal-hero.webp" srcSet="/images/hero/website-optimization-legal-hero-sm.webp 800w, /images/hero/website-optimization-legal-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Website Optimization for Law Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Convert Website Visitors Into Consultations
              <br />
              <span className="text-spark-400">Potential Clients Visit Your Site. Then They Leave.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-4xl mb-8">
              Get a team that optimizes your law firm&apos;s website to convert clear practice area pages, compelling attorney profiles, and frictionless contact flows that turn visitors into booked consultations.
            </p>
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-4xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;We went from page 5 on Google to position 2 for our main keyword in 8 weeks. Inbound leads tripled without spending an extra dollar on ads. The ROI in the first quarter alone covered the full year.&rdquo;
              </p>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-legal-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Website Optimization for Law Firms | Get Levrg",
        description: "Turn law firm website visitors into booked consultations. Clear practice areas, compelling attorney profiles, and frictionless contact flows live in 30 days.",
        keywords: "website optimization for law firms, law firm website design, attorney website conversion",
        ogTitle: "Website Optimization for Law Firms | Get Levrg",
        ogDescription: "Potential clients visit your site. Then they leave. Fix that.",
        ogImage: "/images/hero/website-optimization-legal-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
