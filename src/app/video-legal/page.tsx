...
import { ArrowRight, Zap, TrendingUp, Shield, Star, CalendarDays, Lock, Mail, Scale, Film, Video, Sparkles, Palette } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img src="/images/hero/video-legal-hero.webp" srcSet="/images/hero/video-legal-hero-sm.webp 800w, /images/hero/video-legal-hero.webp 1440w" sizes="100vw" width="1440" height="804"
          alt=""
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a dedicated video editing team that produces client-facing explainers, attorney profiles, and thought leadership content so your firm builds trust before the first consultation.
            </p>
          ...
          <HeroFormIntro animation={<VideoAnimation config={{
            headerIcon: Scale,
            headerTitle: "Legal Content",
            stats: [
              { icon: Film, label: "Attorney Profiles", value: "4/mo", delay: 0.5, accent: "bg-sky-50 border-sky-200", iconColor: "text-sky-500", valueColor: "text-sky-700" },
              { icon: Video, label: "Client Explainers", value: "6/mo", delay: 0.8, accent: "bg-spark-50 border-spark-200", iconColor: "text-spark-600", valueColor: "text-[#4A6F27]" },
              { icon: Sparkles, label: "Firm Highlights", value: "4/mo", delay: 1.1, accent: "bg-teal-50 border-teal-200", iconColor: "text-teal-500", valueColor: "text-teal-700" },
              { icon: Palette, label: "Social Clips", value: "8/mo", delay: 1.4, accent: "bg-amber-50 border-amber-200", iconColor: "text-amber-500", valueColor: "text-amber-700" },
            ],
          }} />}>
            <div className="rounded-2xl border border-gray-200 bg-white/95 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
              ...
              <form id="video-legal-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Video Editing for Law Firms | Get Levrg",
        description: "Professional video production for law firms. Dedicated editors for client-facing explainers, attorney profiles, and thought leadership content.",
        keywords: "video editing for law firms, attorney profile video, legal content production",
        ogTitle: "Video Editing for Law Firms | Get Levrg",
        ogDescription: "Professional video for law firms without the production hassle.",
        ogImage: "/images/hero/video-legal-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
