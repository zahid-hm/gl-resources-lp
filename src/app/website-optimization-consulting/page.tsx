...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, BookOpen } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/website-optimization-consulting-hero.webp" srcSet="/images/hero/website-optimization-consulting-hero-sm.webp 800w, /images/hero/website-optimization-consulting-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Website Optimization for Consulting Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              A Website That Positions You As The Authority
              <br />
              <span className="text-spark-400">Your Website Says You&apos;re Experts. Does It Prove It?</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-4xl mb-8">
              Get a team that builds a credibility-first website for your consulting firm case studies, methodology pages, and thought leadership that makes prospects confident before the first call.
            </p>
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-4xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;We&apos;d been meaning to update the website for three years. Within 30 days we had a completely new site and within 90 days we had more inbound leads than the entire previous year combined.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Managing Partner, B2B Strategy Consulting</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-consulting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Website Optimization for Consulting Firms | Get Levrg",
        description: "Build a credibility-first website for your consulting firm. Case studies, methodology, and thought leadership that converts prospects before the first call.",
        keywords: "website optimization for consulting firms, consulting firm website design, consulting website credibility",
        ogTitle: "Website Optimization for Consulting Firms | Get Levrg",
        ogDescription: "Your website says you're experts. Build one that proves it.",
        ogImage: "/images/hero/website-optimization-consulting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
