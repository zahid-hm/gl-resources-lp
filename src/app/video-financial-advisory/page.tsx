  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          src="/images/hero/video-financial-advisory-hero.webp"
          alt=""
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <HeroFormIntro animation={<VideoAnimation config={{
            ...
            stats: [
              ...
              { icon: Video, label: "Educational Videos", value: "8/mo", delay: 0.8, accent: "bg-spark-50 border-spark-200", iconColor: "text-spark-600", valueColor: "text-[#51B027]" },
