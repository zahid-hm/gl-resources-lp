...
/* ════════════════════════════════════════════════════════════════════════════
   SAMPLE — VARIANT 2, "mobile app" iteration
   Same "Form Isolated" copy as VideoPageV2, but on mobile:
...
function VideoSection({ onOpenForm }: { onOpenForm: () => void }) {
  ...
  return (
    <section id="sv-watch" className="py-16 sm:py-24 bg-gray-50 overflow-hidden scroll-mt-28">
...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <MobileAppNav
        tabs={[
          { id: "sv-watch", label: "Watch", icon: Play },
      ...
      <MobileInfoSheet open={formOpen} onClose={() => setFormOpen(false)} title="Let&apos;s Start Today">
        <LeadForm idPrefix="v2-mobile" onSubmitted={() => setFormOpen(false)} />
      </MobileInfoSheet>
