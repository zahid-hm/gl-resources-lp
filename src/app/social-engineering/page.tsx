...
import { ArrowRight, Smartphone, Clock, Quote, Lock, Mail, Shield, Wrench } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/social-engineering-hero.webp" srcSet="/images/hero/social-engineering-hero-sm.webp 800w, /images/hero/social-engineering-hero.webp 1440w" sizes="100vw" width="1440" height="786" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Social Media for Engineering Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Build Visibility In Your Engineering Niche
              <br />
              <span className="text-spark-400">The Firms Winning Projects Are The Ones People See.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a social media team that builds your engineering firm&apos;s industry presence project highlights, technical thought leadership, and company culture content that keeps your firm visible to project owners and partners.
            </p>
            ...
            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                ...
                { icon: Wrench, text: "Strategy & Creative Managed" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <div className="flex items-center gap-3 pl-8">
                <img
                  ...
                  alt="Managing Principal"
                  loading="lazy"
                  decoding="async"
                  className="w-9 h-9 rounded-full object-cover shrink-0"
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Managing Principal</p>
                  <p className="text-xs text-gray-400">Regional Engineering Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="social-engineering-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Social Media Management for Engineering Firms | Get Levrg",
        description: "Build visibility in your engineering niche — project highlights, technical thought leadership, and culture content from a dedicated social media team.",
        keywords: "social media for engineering firms, engineering firm LinkedIn, engineering industry presence social media",
        ogTitle: "Social Media Management for Engineering Firms | Get Levrg",
        ogDescription: "The firms winning projects are the ones people see. Build your industry presence.",
        ogImage: "/images/hero/social-engineering-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <ToolsWeUseSection />
      <ClientImpactSection />
      <CaseExamplesSection industry="engineering" />
      <WorkSampleBentoGrid />
      <CostComparisonSection />
      <WhyChooseUsSection />
      <HowItWorksSection />
      <TestimonialsSection industry="engineering" />
      <FAQSection />
      <FinalCTASection />
    </PageShell>
  );
