...
import { ArrowRight, Quote, Lock, Mail, Shield, TrendingUp, Target, Calendar } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/linkedin-financial-advisory-hero.webp" srcSet="/images/hero/linkedin-financial-advisory-hero-sm.webp 800w, /images/hero/linkedin-financial-advisory-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">LinkedIn Outbound For Financial Advisors</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Reach High-Net-Worth Prospects On LinkedIn
              <br />
              <span className="text-spark-400">Your Ideal Clients Are On LinkedIn. Your Competitors Are Already Reaching Them.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              We build targeted outreach campaigns that connect financial advisors with high-net-worth individuals and business owners — compliantly, professionally, and at scale.
            </p>

            <div className="gl-reveal gl-d3 flex flex-wrap items-center gap-3 sm:gap-4 mb-10">
              {[
                { icon: Target, text: "10–20 Qualified prospects/mo" },
                { icon: Calendar, text: "14 Days First outreach sent" },
                { icon: Shield, text: "100% Compliance-friendly" },
              ].map((m, i) => {
                const Icon = m.icon;
                return (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;We added $12M in AUM in the first six months, almost entirely from LinkedIn-sourced conversations.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                ...
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Wealth Advisor</p>
                  <p className="text-xs text-gray-400">Independent RIA</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-financial-advisory-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
/* ════════════════════════════════════════════════════════════════════════════
   EXPORT: LinkedInFinancialAdvisoryPage
   ════════════════════════════════════════════════════════════════════════════ */
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "LinkedIn Outbound for Financial Advisors | Get Levrg",
        description: "Reach high-net-worth individuals and business owners through compliant, targeted LinkedIn outreach. Build a predictable pipeline for your advisory practice.",
        keywords: "LinkedIn outbound for financial advisors, wealth management lead generation, RIA LinkedIn prospecting",
        ogTitle: "LinkedIn Outbound for Financial Advisors | Get Levrg",
        ogDescription: "Your ideal clients are on LinkedIn. Your competitors are already reaching them.",
        ogImage: "/images/hero/linkedin-financial-advisory-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
