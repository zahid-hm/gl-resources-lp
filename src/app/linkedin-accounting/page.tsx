...
import { ArrowRight, Quote, Lock, Mail, Shield, Check, Calculator, Target, Calendar, Clock } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/linkedin-accounting-hero.webp" srcSet="/images/hero/linkedin-accounting-hero-sm.webp 800w, /images/hero/linkedin-accounting-hero.webp 1440w" sizes="100vw" width="1440" height="804" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              <Calculator className="h-3.5 w-3.5 text-spark-300" />
              <span className="text-sm-body font-medium text-white">LinkedIn Pipeline For Accounting Firms</span>
            </div>

            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              Your Next 10 Clients Are On LinkedIn.
              <br />
              <span className="text-spark-400">You&apos;re Just Not Reaching Them.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-6">
              Build a higher-value client base by reaching out to decision-makers who need specialized accounting, audit, and tax expertise through targeted LinkedIn outreach.
            </p>

            <ul className="gl-reveal gl-d25 space-y-2 mb-8">
              {[
                "Qualified conversations with the right-fit prospects",
                "More consistent outreach beyond referrals",
                "Managed execution without adding admin to your team",
              ].map((b, i) => (
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-2xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;We signed 4 new clients in the first quarter from LinkedIn alone. Haven&apos;t cold called in months.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                <img
                  src="/images/client/leslie-heller.webp"
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Regional CPA Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="linkedin-accounting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "LinkedIn Pipeline Generation for Accountants | Get Levrg",
        description: "Build a better client base through targeted LinkedIn outreach. Reach decision-makers needing accounting, audit, and tax help — qualified meetings in 14 days.",
        keywords: "LinkedIn outbound for accounting firms, CPA firm lead generation, accounting firm LinkedIn outreach",
        ogTitle: "LinkedIn Pipeline Generation for Accountants | Get Levrg",
        ogDescription: "Your next 10 clients are on LinkedIn. You're just not reaching them.",
        ogImage: "/images/hero/linkedin-accounting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
      ...
      <WhyChooseUsSection />
      <HowItWorksSection />
      <TestimonialsSection industry="accounting" />
      <FAQSection />
      <FinalCTASection />
    </PageShell>
  );
