...
import { ArrowRight, Zap, TrendingUp, Shield, Star, CalendarDays, Lock, Mail, BookOpen, Film, Video, Sparkles, Palette } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <img src="/images/hero/video-consulting-hero.webp" srcSet="/images/hero/video-consulting-hero-sm.webp 800w, /images/hero/video-consulting-hero.webp 1440w" sizes="100vw" width="1440" height="804"
          alt=""
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-2xl mb-8">
              Get a dedicated video editing team that transforms presentations, interviews, and raw recordings into polished thought leadership content positioning your consultants as the authority in their space.
            </p>
          ...
          <HeroFormIntro animation={<VideoAnimation config={{
            ...
            stats: [
              { icon: Film, label: "Expert Interviews", value: "4/mo", delay: 0.5, accent: "bg-sky-50 border-sky-200", iconColor: "text-sky-500", valueColor: "text-sky-700" },
              { icon: Video, label: "LinkedIn Clips", value: "12/mo", delay: 0.8, accent: "bg-spark-50 border-spark-200", iconColor: "text-spark-600", valueColor: "text-[#4A6F27]" },
              { icon: Sparkles, label: "Webinar Edits", value: "6/mo", delay: 1.1, accent: "bg-teal-50 border-teal-200", iconColor: "text-teal-500", valueColor: "text-teal-700" },
              { icon: Palette, label: "Highlight Reels", value: "8/mo", delay: 1.4, accent: "bg-amber-50 border-amber-200", iconColor: "text-amber-500", valueColor: "text-amber-700" },
            ],
          }} />}>
            <div className="rounded-2xl border border-gray-200 bg-white/95 backdrop-blur-xl shadow-2xl p-6 sm:p-8">
              ...
              <form id="video-consulting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Video Editing for Consulting Firms | Get Levrg",
        description: "Turn consulting expertise into thought leadership video. Dedicated editors transform presentations and recordings into polished content that builds authority.",
        keywords: "video editing for consultants, thought leadership video, consulting firm video content",
        ogTitle: "Video Editing for Consulting Firms | Get Levrg",
        ogDescription: "Turn consulting expertise into thought leadership video. Dedicated editors, polished content.",
        ogImage: "/images/hero/video-consulting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
