...
import { ArrowRight, Zap, BarChart3, TrendingUp, Quote, Calculator } from "lucide-react";
  ...
  return (
    <section id="lead-form" className="relative overflow-hidden min-h-[500px] sm:min-h-[600px]">
      <div className="absolute inset-0">
        <img src="/images/hero/website-optimization-accounting-hero.webp" srcSet="/images/hero/website-optimization-accounting-hero-sm.webp 800w, /images/hero/website-optimization-accounting-hero.webp 1440w" sizes="100vw" width="1440" height="786" alt="" className="absolute inset-0 w-full h-full object-cover" fetchPriority="high" decoding="async" />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-3">
            <div className="gl-reveal gl-dur5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-8">
              ...
              <span className="text-sm-body font-medium text-white">Website Optimization for Accounting Firms</span>
            </div>
            ...
            <h1 className="gl-reveal gl-d1 text-h1 sm:text-display lg:text-display-sm text-white mb-6">
              ...
              <br />
              <span className="text-spark-400">Your Website Is A Brochure. It Should Be A Lead Machine.</span>
            </h1>

            <p className="gl-reveal gl-d2 text-body sm:text-sub text-gray-300 max-w-4xl mb-8">
              Get a team that transforms your accounting firm&apos;s website from a static page into a lead-generating engine modern design, clear messaging, and conversion-optimized pages that turn visitors into consultations.
            </p>
            ...
            <div className="gl-reveal gl-d4 relative p-5 sm:p-6 rounded-xl bg-white/10 border border-white/20 backdrop-blur-sm max-w-4xl">
              ...
              <p className="text-sm-body sm:text-body text-gray-200 italic mb-3 pl-8">
                &ldquo;Our contact form had been broken for over a year. Get Levrg fixed it on day one, rebuilt our service pages, and we doubled consultation requests within 60 days.&rdquo;
              </p>
              <div className="flex items-center gap-3 pl-8">
                ...
                />
                <div>
                  <p className="text-sm-body font-semibold text-white">Sandra Park, CPA</p>
                  <p className="text-xs text-gray-400">Managing Director, Regional Accounting Firm</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <HeroFormIntro>
            <div className="rounded-2xl border border-gray-200 bg-white shadow-lg p-6 sm:p-8">
              ...
              <form id="website-optimization-accounting-hero-form" onSubmit={handleSubmit(onValid)} noValidate className="space-y-4">
...
export default function Page() {
  return (
    <PageShell
      ...
      ctaTarget="#lead-form"
      meta={{
        title: "Website Optimization for Accounting Firms | Get Levrg",
        description: "Transform your accounting firm's website into a lead-generating engine. Modern design, clear messaging, and conversion-optimized pages launch in 30 days.",
        keywords: "website optimization for accounting firms, CPA firm website design, accounting firm lead generation website",
        ogTitle: "Website Optimization for Accounting Firms | Get Levrg",
        ogDescription: "Your accounting firm's website should generate consultations, not just sit there.",
        ogImage: "/images/hero/website-optimization-accounting-hero.webp",
      }}
    >
      <HeroSection />
      <TrustedByMarquee />
